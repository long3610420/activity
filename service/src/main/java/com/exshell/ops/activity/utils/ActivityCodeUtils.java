...
public class ActivityCodeUtils {
    ...
    // private static final Logger log = LoggerFactory.getLogger(ActivityCodeUtils.class);
       private static final long startNumber = 33554431L;
...
//             log.debug(ind + "-->" + res);
    ...
    public static void main(String[] args) {
        String x = idToCode(394531034);
        System.out.println(x);
        System.out.println(codeToId("AX2SDZ"));
        String x1 = idToCode(1073741824);
        System.out.println(x1);
        System.out.println(codeToId("7495CQ"));
    }
}
